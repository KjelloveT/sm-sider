/* ══════════════════════════════════════════════
   VYRDEPIL — Felles Lucide-ikonsett (inline SVG, sjølv-hosta)

   Éi kjelde for alle spel og verktøy. Ingen ekstern avhengnad:
   berre SVG path-data (Lucide, MIT/ISC) bakt inn i vår eigen kode.
   Erstattar dei tidlegare per-spel icons.js-filene.

   Namnekonvensjon: camelCase (t.d. arrowRight, mapPin, trash2).
   Verdien er berre den indre path-markupen; <svg>-wrapperen med
   storleik/strek/klasse blir generert av ICON() slik at han er lik
   overalt.

   Bruk:  ICON('globe', 20)                 -> '<svg …>…</svg>'
          <span data-icon="globe"></span>   + hydrateIcons()
   ══════════════════════════════════════════════ */
(function (global) {
  'use strict';
  ...
  copy: '<rect width="9" height="13" x="9" y="9" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/>',
  ...
  flipHorizontal: '<path d="M8 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3"/><path d="M16 3h3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-3"/><path d="M12 20v2"/><path d="M12 14v2"/><path d="M12 8v2"/><path d="M12 2v2"/>',
  ...
  micOff: '<path d="M12 19v3"/><path d="M19 10v2a7 7 0 0 1-.11 1.23"/><path d="M15 9.34V5a3 3 0 0 0-5.68-1.33"/><path d="M9 9v3a3 3 0 0 0 5.12 2.12"/><path d="M5 10v2a7 7 0 0 0 12 4.9"/><line x1="2" x2="22" y1="2" y2="22"/>',
  ...
  minusCircle: '<circle cx="12" cy="12" r="10"/><line x1="8" x2="16" y1="12" y2="12"/>',
  ...
  trafficLight: '<rect x="8" y="2" width="8" height="20" rx="2"/><circle cx="12" cy="6.5" r="1.5"/><circle cx="12" cy="12" r="1.5"/><circle cx="12" cy="17.5" r="1.5"/>',
  ...
  trophy: '<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>',
  ...
  function has(name) { return name in ICON_PATHS; }

  // Global drop-in (spel kallar ICON()/hydrateIcons() direkte) + namespace.
  global.ICON = ICON;
  global.hydrateIcons = hydrateIcons;
  global.VyrdepilIcons = { ICON, hydrateIcons, has, ICON_PATHS };
