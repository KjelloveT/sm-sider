/* Ormritaren — enkel formatering i læretekst og oppgåvetekst.
 *
 * To ting, og ikkje fleire:
 *   **utheva**   → <strong>
 *   `kode`       → <code> i maskinskrift
 *
 * Kodeord midt i ei setning er det viktigaste av dei to. Utan eiga skrift er
 * det vanskeleg å sjå kva som er Python og kva som er norsk — «skilnaden på
 * pris * tal og "pris * tal"» er nesten uleseleg som rein tekst.
 *
